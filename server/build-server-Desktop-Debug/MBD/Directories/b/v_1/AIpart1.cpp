...
void initialize()
{
	...
	int variablenumber=(vertices*subGraphs+edges)*subGraphs;
	int clausenumber=edges*(3*subGraphs+1)+subGraphs+subGraphs*(subGraphs-1)*(3*vertices+1)+((vertices*(vertices-1)/2)-edges)*subGraphs; 
